...
from models.usuario import Usuario  # Importa os modelos de onde você precisa

routes = Blueprint('routes', __name__)

@routes.route('/')
def home():
    # Aqui você pode usar o modelo Usuario, por exemplo
    usuarios = Usuario.query.all()
    return render_template('pagina-login.html', usuarios=usuarios)"""